...
#define NEEDS_ONE_OPERAND(opcode)       ((opcode >= 0x07 && opcode <= 0x09) || opcode == 0x11 || (opcode >= 0x19 && opcode <= 0x22) || (opcode >= 0x24 && opcode <= 0x2B) || opcode == 0x3B || (opcode >= 0x3D && opcode <= 0x40) || opcode == 0x47 || opcode == 0x48)
...
#define IMM_AS_OPERAND1(opcode)         (opcode == 0x48)
